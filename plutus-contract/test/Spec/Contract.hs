...
tests =
    let runOld :: Slot -> String -> TracePredicate -> EmulatorTrace () -> _
        ...
        run :: Slot -> String -> TracePredicate -> EmulatorTrace () -> _
    ...
    testGroup "contracts"
        ...
        , checkOld 1 "watchAddressUntilSlot" (void $ watchAddressUntilSlotOld someAddress 5) $ \con ->
            waitingForSlot con tag 5
        , check 1 "watchAddressUntilSlot" (void $ watchAddressUntilSlotOld someAddress 5) $ \con ->
            waitingForSlot con tag 5
        ...
        , let theContract :: Contract () Schema ContractError () = void $ awaitUtxoProducedOld (walletAddress w2)
        ...
        , let theContract :: Contract () Schema ContractError () = void (utxoAtOld (walletAddress w1) >>= awaitUtxoSpentOld . fst . head . Map.toList)
        ...
        , runOld 1 "error handling & checkpoints"
